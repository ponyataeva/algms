...
class BinarySearchRecursiveTest {
    ...
    void binarySearch_whenTargetElementLast_thenFindIt() {
        var actual = BinarySearchRecursive.search(new int[]{1, 2, 3, 4, 6}, 6);
    ...
    void binarySearch_whenArrayWithEvenLength_thenFindElement() {
        var actual = BinarySearchRecursive.search(new int[]{2, 5, 8, 12, 16, 23, 38, 56, 72, 91}, 23);
    ...
    void binarySearch_whenElementNotInArray_thenReturnMinusOne() {
        var actual = BinarySearchRecursive.search(new int[]{2, 5, 8, 12, 16, 23, 38, 56, 72, 91}, 20);
    ...
    void binarySearch_whenFirstElement_thenFindIt() {
        var actual = BinarySearchRecursive.search(new int[]{2, 5, 8, 12, 16, 23, 38, 56, 72, 91}, 2);
    ...
    void binarySearch_whenValueLowerThenMinimumValue_thenReturnMinusOne() {
        var actual = BinarySearchRecursive.search(new int[]{2, 5, 8, 12, 16, 23, 38, 56, 72, 91}, -1);
    ...
    void binarySearch_whenValueHigherThenMaxValue_thenReturnMinusOne() {
        var actual = BinarySearchRecursive.search(new int[]{2, 5, 8, 12, 16, 23, 38, 56, 72, 91}, 100);
    ...
    void binarySearch_whenFirstNegativeNumber_thenReturnMinusOne() {
        var actual = BinarySearchRecursive.search(new int[]{-2, -1, 5, 8, 12, 16, 23, 38, 56, 72, 91}, -2);
    ...
    void binarySearch_whenNegativeNumber_thenReturnMinusOne() {
        var actual = BinarySearchRecursive.search(new int[]{-2, -1, 5, 8, 12, 16, 23, 38, 56, 72, 91}, -1);
    ...
    void binarySearch_whenBigArray_thenFindNumber() {
        ...
        var actual = BinarySearchRecursive.search(array, 183965);
